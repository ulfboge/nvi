...
| SLU Skogskarta 2018 + kol 2023 (optional) | `E:/slu_gis/...` by default if `E:` exists (`SLU_GIS_LARGE_ROOT` in `.env` to override) | Struktur + fukt; `download_data.py --slu-forest-map-confirm` / `--slu-carbon-confirm` |
